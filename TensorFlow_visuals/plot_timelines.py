...
def plot_pids_timeline_cpu(start=None, end=None, outname=None):
    ...
    fig.suptitle("3D_UNet TensorFlow Image Segmentation")
...
if __name__ == "__main__":
    ...
    plot_pids_timeline_cpu(outname="timelines/all",start="2022-03-31T15:11:00",
        end="2022-03-31T16:36:20",)
    plot_pids_timeline_cpu(outname="timelines/all_f030",start="2022-03-31T15:11:00",
        end="2022-03-31T15:11:30",)
    plot_pids_timeline_cpu(outname="timelines/all_f2",start="2022-03-31T15:11:00",
        end="2022-03-31T15:13:00",)
    plot_pids_timeline_cpu(outname="timelines/all_f5",start="2022-03-31T15:11:00",
        end="2022-03-31T15:16:00",)
    plot_pids_timeline_cpu(outname="timelines/all_f15",start="2022-03-31T15:11:00",
        end="2022-03-31T15:26:00",)
    plot_pids_timeline_cpu(outname="timelines/all_l2",start="2022-03-31T16:34:20",
        end="2022-03-31T16:36:20",)
    plot_pids_timeline_cpu(outname="timelines/all_l5",start="2022-03-31T16:31:20",
        end="2022-03-31T16:36:20",)
    plot_pids_timeline_cpu(outname="timelines/all_l15",start="2022-03-31T16:21:20",
        end="2022-03-31T16:36:20",)
